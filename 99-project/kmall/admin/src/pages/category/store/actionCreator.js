...
export const getUpdataNameAction = (id,newName)=>{
    return (dispatch,getState)=>{
...
export const getUpdataMobileNameAction = (id,newMobileName)=>{
    return (dispatch,getState)=>{
        const page = getState().get('category').get('current')
        api.updateCategoriesMoboleName({
            id:id,
...
export const getUpdataOrderAction = (id,newOrder)=>{
    return (dispatch,getState)=>{
        const page = getState().get('category').get('current')
